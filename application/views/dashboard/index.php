...
<div class="row">
  <div class="col-lg-20 col-md-6 col-6 mb-3" data-aos="fade-up" data-aos-delay="100">
  ...
  <div class="col-lg-20 col-md-6 col-6 mb-3" data-aos="fade-up" data-aos-delay="200">
  ...
  <div class="col-lg-20 col-md-6 col-6 mb-3" data-aos="fade-up" data-aos-delay="300">
    <div class="small-box bg-info">
      <div class="inner">
        <h3 style="font-size:1.4rem;">Rp <?= number_format($total_pemasukan, 0, ',', '.') ?></h3>
        <p>Pemasukan Kas</p>
      </div>
      <div class="icon"><i class="fas fa-hand-holding-usd"></i></div>
      <a href="<?= base_url('keuangan/pemasukan') ?>" class="small-box-footer">
        Lebih Lanjut <i class="fas fa-arrow-circle-right ml-1"></i>
      </a>
    </div>
  </div>

  <div class="col-lg-20 col-md-6 col-6 mb-3" data-aos="fade-up" data-aos-delay="400">
    <div class="small-box bg-warning">
      <div class="inner">
        <h3 style="font-size:1.4rem;">Rp <?= number_format($total_pengeluaran, 0, ',', '.') ?></h3>
        <p>Pengeluaran Kas</p>
      </div>
      <div class="icon"><i class="fas fa-file-invoice-dollar"></i></div>
      <a href="<?= base_url('keuangan/pengeluaran') ?>" class="small-box-footer">
        Lebih Lanjut <i class="fas fa-arrow-circle-right ml-1"></i>
      </a>
    </div>
  </div>

  <div class="col-lg-20 col-md-6 col-6 mb-3" data-aos="fade-up" data-aos-delay="500">
  ...
  <div class="col-lg-4 mb-3" data-aos="fade-left" data-aos-delay="600">
    <div class="card card-danger">
              ...
              <li style="padding: 0.85rem 1.1rem; border-bottom: 1px solid #f1f5f9;">
                <div style="display:flex; justify-content:space-between; align-items:center; gap:0.5rem;">
                  <div style="min-width:0;">
                    <div
                      style="font-weight:600; color:var(--emerald-900); font-size:0.92rem; white-space:nowrap; overflow:hidden; text-overflow:ellipsis;">
                      <?= htmlspecialchars($w->nama_lengkap, ENT_QUOTES) ?>
                    </div>
                    <div style="font-size:0.78rem; color:#64748b; margin-top:2px;">
                      Total: <strong style="color:#dc2626;">Rp
                        <?= number_format($w->total_tunggakan, 0, ',', '.') ?></strong>
                    </div>
                  </div>
      ...
      <div class="card-footer text-center" style="background: rgba(239,68,68,0.05);">
        <a href="<?= base_url('iuran/tunggakan') ?>"
          style="color:#dc2626; font-weight:600; font-size:0.85rem; text-decoration:none;">
