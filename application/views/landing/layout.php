...
<head>
  ...
  <style>
    ...
    .pub-bottom-nav a.active i {
      transform: scale(1.15);
    }

    .pub-bottom-nav a:hover {
      color: var(--emerald-600);
      text-decoration: none;
    }
    ...
    .pub-desktop-links a:hover {
      color: var(--emerald-700);
      background: var(--emerald-50);
      text-decoration: none;
    }

    .pub-desktop-links a.active {
      color: var(--emerald-700);
      background: var(--emerald-50);
      font-weight: 700;
    }
    ...
    .pub-stat-icon.balance {
      background: #d1fae5;
      color: var(--emerald-700);
    }

    .pub-stat-icon.income {
      background: #dcfce7;
      color: #059669;
    }

    .pub-stat-icon.expense {
      background: #fecaca;
      color: #dc2626;
    }
    ...
    .pub-stat-value.balance {
      color: var(--emerald-800);
    }

    .pub-stat-value.income {
      color: #059669;
    }

    .pub-stat-value.expense {
      color: #dc2626;
    }
    ...
    /* ===== Struktur Organisasi (Mobile: Vertical, Desktop: Horizontal) ===== */
    .orgchart-wrapper {
      padding: 1rem 0;
