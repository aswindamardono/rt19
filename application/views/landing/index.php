...
<head>
  ...
  <style>
    ...
    .public-stat-icon.balance {
      background: #d1fae5;
      color: var(--emerald-700);
    }

    .public-stat-icon.income {
      background: #dcfce7;
      color: #059669;
    }

    .public-stat-icon.expense {
      background: #fecaca;
      color: #dc2626;
    }
    ...
    .public-stat-value.balance {
      color: var(--emerald-800);
    }

    .public-stat-value.income {
      color: #059669;
    }

    .public-stat-value.expense {
      color: #dc2626;
    }
    ...
    .org-tree li::before {
      right: 50%;
      border-right: 2px solid var(--emerald-300);
    }
    ...
    .org-node.org-root .org-node-nama {
      color: white;
    }

    .org-node.org-root .org-node-nama-empty {
...
<body class="landing-body">
  ...
  <nav class="public-nav">
    <div class="nav-container">
      ...
      <button class="mobile-menu-btn" onclick="toggleNav()"
        style="background:none;border:none;font-size:1.5rem;color:var(--emerald-800);cursor:pointer;display:none;">
  ...
  <div class="public-content">
    ...
    <div class="public-stat" data-aos="fade-up" data-aos-delay="100"
      ...
      <div class="public-stat-icon" style="background:#ecfdf5; color:var(--emerald-600);"><i class="fas fa-sitemap"></i>
      </div>
      <div style="margin-bottom:1rem;">
        <h3
          style="font-family:'Plus Jakarta Sans',sans-serif; color:var(--emerald-900); font-weight:800; font-size:1.15rem; margin-bottom:0.4rem;">
          Bagan Struktur Organisasi</h3>
        <p style="color:#64748b; font-size:0.9rem; margin:0;">Lihat bagan hierarki dan susunan lengkap pengurus RT-19
          Orchid Regency.</p>
      </div>
      <a href="<?= base_url('struktur-organisasi') ?>" class="public-nav-cta"
        style="display:inline-flex; border-radius:99px; padding:0.6rem 1.5rem; font-size:0.95rem;">
      ...
      <?php if (!empty($pengumuman)): ?>
        <?php foreach ($pengumuman as $i => $p):
          ...
          <article class="ann-card" data-aos="fade-up" data-aos-delay="<?= 100 + $i * 80 ?>">
            <?php if ($has_img): ?>
              <img class="ann-card-img" src="<?= base_url('uploads/pengumuman/' . $p->gambar) ?>"
                alt="<?= htmlspecialchars($p->judul, ENT_QUOTES) ?>" onerror="this.style.display='none'">
            <?php endif; ?>
      ...
      <?php if (!empty($inventaris)): ?>
        <?php foreach ($inventaris as $inv): ?>
          <div class="public-stat" data-aos="fade-up">
            <div class="public-stat-icon" style="background:#f1f5f9; color:var(--emerald-600);"><i class="fas fa-box"></i>
            </div>
