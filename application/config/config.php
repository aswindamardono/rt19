...
|
*/
// Fix for lowercase/uppercase folder name issue in Windows (e.g. /rt19 vs /RT19)
if (isset($_SERVER['REQUEST_URI'], $_SERVER['SCRIPT_NAME'])) {
    $req_uri = parse_url('http://dummy' . $_SERVER['REQUEST_URI'], PHP_URL_PATH);
    $script_dir = str_replace('\\', '/', dirname($_SERVER['SCRIPT_NAME']));
    
    if ($script_dir !== '/' && stripos($req_uri, $script_dir) === 0) {
        $actual_dir = substr($req_uri, 0, strlen($script_dir));
        $_SERVER['SCRIPT_NAME'] = rtrim($actual_dir, '/') . '/' . basename($_SERVER['SCRIPT_NAME']);
    }
}
...
|
*/
$config['encryption_key'] = 'RT19OrchidRegencySidoarjo2024';
...
$config['sess_cookie_name'] = 'rt19_session';
...
$config['csrf_token_name'] = 'csrf_rt19';
$config['csrf_cookie_name'] = 'csrf_cookie_rt19';
$config['csrf_expire'] = 7200;
$config['csrf_regenerate'] = TRUE;
$config['csrf_exclude_uris'] = array(
    'warga/datatable',
    'keuangan/pemasukan_datatable',
    'keuangan/pengeluaran_datatable',
    'iuran/datatable',
    'surat/datatable',
